local _2afile_2a = "/home/truff/.config/nvim/fnl/Lang/Cmp-Nvim.fnl"
...
local luasnip, cmp, comparator, dictionary = autoload("luasnip"), autoload("cmp"), autoload("cmp-under-comparator"), autoload("cmp_dictionary")
