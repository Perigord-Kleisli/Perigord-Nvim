local _2afile_2a = "fnl/Plugin_REMOTE_38270.fnl"
...
do
  ...
  if status_ok_2_auto then
    _31_ = module_name_3_auto.setup({diagnostics = "nvim_lsp"})
  else
...
do
  ...
  if status_ok_2_auto then
    _46_ = module_name_3_auto.setup({languages = {haskell = {compiler = "ghc901"}}})
  else
    _46_ = print("Error Configuring", "godbolt", "\n")
  end
end
local _49_
do
  ...
  if status_ok then
    _49_ = presence:setup({neovim_image_text = "Neovim"})
  else
    _49_ = print("Error Configuring: Presence")
  end
end
use({["Olical/aniseed"] = {}, ["wbthomason/packer.nvim"] = {}, ["lewis6991/impatient.nvim"] = {}, ["MunifTanjim/nui.nvim"] = {}, ["nvim-lua/plenary.nvim"] = {}, ["nvim-lua/popup.nvim"] = {}, ["arp242/undofile_warn.vim"] = {}, ["tpope/vim-surround"] = {}, ["windwp/nvim-autopairs"] = {config = _6_}, ["andymass/vim-matchup"] = {}, ["Trouble-Truffle/Prog-Nvim"] = a.merge({config = (Func.alternative(require, _9_, "prog")).setup()}, {requires = {{"Trouble-Truffle/PeriLib-Nvim"}}}), ["preservim/nerdcommenter"] = {}, ["s1n7ax/nvim-comment-frame"] = a.merge({config = (Func.alternative(require, _11_, "nvim-comment-frame")).setup()}), ["folke/todo-comments.nvim"] = a.merge({config = (Func.alternative(require, _13_, "todo-comments")).setup()}), ["ggandor/lightspeed.nvim"] = {}, ["tpope/vim-fugitive"] = {}, ["TimUntersberger/neogit"] = a.merge({config = (Func.alternative(require, _15_, "neogit")).setup()}), ["f-person/git-blame.nvim"] = {}, ["lewis6991/gitsigns.nvim"] = a.merge({config = (Func.alternative(require, _17_, "gitsigns")).setup()}), ["editorconfig/editorconfig-vim"] = {}, ["nvim-telescope/telescope.nvim"] = {["conf-module"] = "Util.Telescope", requires = {{"nvim-telescope/telescope-file-browser.nvim"}, {"nvim-telescope/telescope-media-files.nvim"}, {"nvim-telescope/telescope-dap.nvim"}, {"nvim-telescope/telescope-ui-select.nvim"}}}, ["kyazdani42/nvim-tree.lua"] = {["conf-module"] = "Util.NvimTree", requires = "kyazdani42/nvim-web-devicons"}, ["akinsho/toggleterm.nvim"] = a.merge({config = (Func.alternative(require, _19_, "toggleterm")).setup()}), ["folke/which-key.nvim"] = {["conf-module"] = "Mapping", requires = "mrjones2014/legendary.nvim"}, ["farmergreg/vim-lastplace"] = {}, ["rmagatti/auto-session"] = {config = _21_}, ["ekickx/clipboard-image.nvim"] = {}, ["luukvbaal/stabilize.nvim"] = a.merge({config = (Func.alternative(require, _24_, "stabilize")).setup()}), ["rcarriga/nvim-notify"] = {}, ["nacro90/numb.nvim"] = a.merge({config = (Func.alternative(require, _26_, "numb")).setup()}), ["yamatsum/nvim-cursorline"] = {config = _28_}, ["lukas-reineke/indent-blankline.nvim"] = {["conf-module"] = "UI.Indent-Blankline"}, ["akinsho/bufferline.nvim"] = {config = _31_}, ["RRethy/vim-hexokinase"] = {run = "make hexokinase"}, ["folke/zen-mode.nvim"] = a.merge({config = (Func.alternative(require, _34_, "zen-mode")).setup()}), ["goolord/alpha-nvim"] = {["conf-module"] = "Startup"}, ["Mofiqul/dracula.nvim"] = {["conf-module"] = "UI.Colorscheme"}, ["stevearc/dressing.nvim"] = a.merge({config = (Func.alternative(require, _36_, "dressing")).setup()}), ["nvim-lualine/lualine.nvim"] = {["conf-module"] = "UI.Lualine", requires = {{"SmiteshP/nvim-gps"}, {"SmiteshP/nvim-navic"}}}, ["camspiers/animate.vim"] = {}, ["rainbowhxch/beacon.nvim"] = {}, ["CRAG666/code_runner.nvim"] = {["conf-module"] = "Lang.CodeRunner"}, ["simrat39/symbols-outline.nvim"] = {}, ["michaelb/sniprun"] = {config = _38_}, ["amrbashir/nvim-docs-view"] = {}, ["j-hui/fidget.nvim"] = a.merge({config = (Func.alternative(require, _41_, "fidget")).setup()}), ["mfussenegger/nvim-dap"] = {["conf-module"] = "Lang.Dap", requires = {{"rcarriga/nvim-dap-ui"}, {"mfussenegger/nvim-dap-python"}, {"theHamsta/nvim-dap-virtual-text"}}}, ["jose-elias-alvarez/null-ls.nvim"] = {["conf-module"] = "Lang.Null-ls"}, ["hrsh7th/nvim-cmp"] = {["conf-module"] = "Lang.Cmp-Nvim", requires = {{"hrsh7th/cmp-nvim-lsp"}, {"L3MON4D3/LuaSnip"}, {"hrsh7th/cmp-calc"}, {"uga-rosa/cmp-dictionary"}, {"lukas-reineke/cmp-under-comparator"}, {"hrsh7th/cmp-cmdline"}, {"hrsh7th/cmp-nvim-lua"}, {"kdheepak/cmp-latex-symbols"}, {"ray-x/cmp-treesitter"}, {"hrsh7th/cmp-nvim-lsp-signature-help"}, {"hrsh7th/cmp-path"}, {"hrsh7th/cmp-buffer"}}}, ["p00f/nvim-ts-rainbow"] = {}, ["nvim-treesitter/nvim-treesitter"] = {["conf-module"] = "Lang.Treesitter", requires = {{"nvim-treesitter/nvim-treesitter-context"}, {"nvim-treesitter/nvim-treesitter-textobjects"}, {"nvim-treesitter/nvim-treesitter-refactor"}}}, ["nvim-treesitter/playground"] = {}, ["davidgranstrom/nvim-markdown-preview"] = {config = nil}, ["neovim/nvim-lspconfig"] = {["conf-module"] = "Lang.LSP", requires = {{"hrsh7th/nvim-cmp"}}}, ["simrat39/rust-tools.nvim"] = a.merge({config = (Func.alternative(require, _43_, "rust-tools")).setup()}), ["LnL7/vim-nix"] = {}, ["vlime/vlime"] = {}, ["bhurlow/vim-parinfer"] = {}, ["justin2004/vim-apl"] = {}, ["glacambre/firenvim"] = {run = _45_}, ["p00f/godbolt.nvim"] = {config = _46_}, ["andweeb/presence.nvim"] = {config = _49_}, ["wakatime/vim-wakatime"] = {}, ["github/copilot.vim"] = {}})
return _2amodule_2a