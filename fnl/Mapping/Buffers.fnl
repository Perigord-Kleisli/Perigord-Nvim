...
(vim.keymap.set :n "<A-,>" (cmd :BufferLineCyclePrev)
                {:noremap true :silent true :desc "Previous Buffer"})
(vim.keymap.set :n "<A-.>" (cmd :BufferLineCycleNext)
                {:noremap true :silent true :desc "Next Buffer"})
(vim.keymap.set :n "<A-S-,>" (cmd :BufferLineMovePrev)
                {:noremap true :silent true :desc "Move Buffer Left"})
(vim.keymap.set :n "<A-S-.>" (cmd :BufferLineMoveNext)
